...
function findWasmBinary() {
  return locateFile('test_init.wasm');
}
...
var ASM_CONSTS = {
  97002: ($0, $1, $2, $3) => { if (typeof window !== 'undefined') { window.aromaLastMouseDispatchAction = $0; window.aromaLastMouseDispatchX = $1; window.aromaLastMouseDispatchY = $2; window.aromaLastMouseDispatchButton = $3; } console.log('dispatch_mouse', $0, $1, $2, $3); },  
 97250: ($0, $1, $2, $3, $4) => { if (typeof window !== 'undefined') { window.aromaLastMouseType = $0; window.aromaLastMouseTarget = $1; window.aromaLastMouseX = $2; window.aromaLastMouseY = $3; window.aromaLastMouseButton = $4; } }
};
...
function assignWasmExports(wasmExports) {
  ...
  _aroma_test_get_last_mouse_event_type = Module['_aroma_test_get_last_mouse_event_type'] = createExportWrapper('aroma_test_get_last_mouse_event_type', wasmExports['aroma_test_get_last_mouse_event_type'], 0);
  _aroma_test_get_last_mouse_event_x = Module['_aroma_test_get_last_mouse_event_x'] = createExportWrapper('aroma_test_get_last_mouse_event_x', wasmExports['aroma_test_get_last_mouse_event_x'], 0);
  _aroma_test_get_last_mouse_event_y = Module['_aroma_test_get_last_mouse_event_y'] = createExportWrapper('aroma_test_get_last_mouse_event_y', wasmExports['aroma_test_get_last_mouse_event_y'], 0);
  _aroma_test_get_last_mouse_event_target = Module['_aroma_test_get_last_mouse_event_target'] = createExportWrapper('aroma_test_get_last_mouse_event_target', wasmExports['aroma_test_get_last_mouse_event_target'], 0);
  _aroma_emscripten_dispatch_mouse = Module['_aroma_emscripten_dispatch_mouse'] = createExportWrapper('aroma_emscripten_dispatch_mouse', wasmExports['aroma_emscripten_dispatch_mouse'], 4);
