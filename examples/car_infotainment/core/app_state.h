...
typedef struct
{
    ...
    AromaFont *ac_font;
    AromaFont *drawer_icon_font;

    AromaFont *drawer_chrome_icon_font;
    ...
    AromaNode *vehicle_view_clock_label;
    AromaNode *vehicle_view_clock_date_label;
    ...
    AromaNode *navigation_icon;
    AromaNode *climate_icon;
    AromaNode *vehicle_view_icon;
    ...
    AromaNode *grid_container;
    AromaNode *grid_items[6];
    int grid_items_count;

    AromaNode *nav_content;
    AromaNode *ac_content;
