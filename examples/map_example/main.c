...
int main()
{
    ...
    AromaFont *icon_font = aroma_font_create_from_memory(icon_ttf, icon_ttf_len, 16);
    AromaNode *zoom_in_button = aroma_ui_iconbutton((AromaNode *)window, AROMA_ICON_ADD, 650, 10, 40, ICON_BUTTON_FILLED, NULL, NULL, icon_font);
    AromaNode *zoom_out_button = aroma_ui_iconbutton((AromaNode *)window, AROMA_ICON_REMOVE, 650, 60, 40, ICON_BUTTON_FILLED, NULL, NULL, icon_font);
    ...
    aroma_node_set_z_index(zoom_in_button, 99999);
    aroma_node_set_z_index(zoom_out_button, 99999);
