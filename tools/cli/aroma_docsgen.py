                ...
                <div class="hero-inner">
                  ...
                  <div class="hero-graphic" aria-hidden="true">
                    <svg viewBox="0 0 360 300" width="100%" role="img">
                      ...
                      <circle cx="306" cy="52" r="8" fill="#B6D1FF"/>
                      <circle cx="52" cy="248" r="9" fill="#B6D1FF"/>
                      <path d="M232 148 C 244 148 246 158 256 164" fill="none" stroke="#B6D1FF" stroke-width="2.5" stroke-dasharray="5 5"/>
                      <clipPath id="heroMonClip"><rect x="36" y="80" width="196" height="124" rx="10"/></clipPath>
                      <rect x="36" y="80" width="196" height="124" rx="10" fill="#FFFFFF" stroke="#D7DBE4" stroke-width="2"/>
                      <g clip-path="url(#heroMonClip)">
                        <rect x="36" y="80" width="196" height="28" fill="#4F8EF7"/>
                        <circle cx="52" cy="94" r="4" fill="#FFFFFF" opacity="0.95"/><circle cx="64" cy="94" r="4" fill="#FFFFFF" opacity="0.7"/><circle cx="76" cy="94" r="4" fill="#FFFFFF" opacity="0.5"/>
                        <rect x="50" y="118" width="80" height="12" rx="6" fill="#296AD4"/>
                        <rect x="50" y="136" width="112" height="8" rx="4" fill="#B6D1FF"/>
                        <rect x="50" y="152" width="82" height="32" rx="4" fill="#EAF2FB"/>
                        <rect x="138" y="152" width="80" height="32" rx="4" fill="#EAF2FB"/>
                        <rect x="50" y="190" width="52" height="4" rx="2" fill="#B6D1FF"/>
                      </g>
                      <rect x="118" y="204" width="32" height="16" fill="#D7DBE4"/>
                      <rect x="96" y="220" width="76" height="9" rx="4.5" fill="#D7DBE4"/>
                      <rect x="240" y="92" width="74" height="154" rx="14" fill="#FFFFFF" stroke="#4F8EF7" stroke-width="4"/>
                      <clipPath id="heroDevClip"><rect x="240" y="92" width="74" height="154" rx="14"/></clipPath>
                      <g clip-path="url(#heroDevClip)">
                        <rect x="240" y="92" width="74" height="26" fill="#4F8EF7"/>
                        <circle cx="277" cy="101" r="2.5" fill="#FFFFFF"/>
                        <rect x="248" y="128" width="58" height="10" rx="5" fill="#296AD4"/>
                        <rect x="248" y="143" width="40" height="7" rx="3.5" fill="#B6D1FF"/>
                        <rect x="248" y="158" width="58" height="30" rx="4" fill="#EAF2FB"/>
                        <rect x="248" y="193" width="58" height="30" rx="4" fill="#EAF2FB"/>
                        <rect x="248" y="228" width="36" height="12" rx="6" fill="#4F8EF7"/>
                      </g>
                      <rect x="52" y="234" width="8" height="7" fill="#B6D1FF"/><rect x="66" y="234" width="8" height="7" fill="#B6D1FF"/><rect x="80" y="234" width="8" height="7" fill="#B6D1FF"/>
                      <rect x="40" y="241" width="70" height="40" rx="6" fill="#FFFFFF" stroke="#D7DBE4" stroke-width="2"/>
                      <rect x="58" y="251" width="34" height="20" rx="3" fill="#8CBF26"/>
                      <circle cx="75" cy="261" r="4" fill="#FFFFFF"/>
                      <rect x="52" y="281" width="8" height="7" fill="#B6D1FF"/><rect x="66" y="281" width="8" height="7" fill="#B6D1FF"/><rect x="80" y="281" width="8" height="7" fill="#B6D1FF"/>
                    </svg>
                  </div>
                </div>
            </div>
...
.home-live{{display:flex;gap:16px;align-items:center;justify-content:center;margin-bottom:64px}}
.home-live-copy{{flex:1 1 0;min-width:0;max-width:520px}}
.home-live-copy .section-heading{{margin-bottom:12px}}
.home-live-text{{color:var(--md-on-surface-var);margin:0 0 14px;font-size:14px;line-height:1.65}}
...
[data-theme="dark"] .home-footer .m3-btn-outlined{{background:transparent;color:#E8EAED;border-color:#48484A;}}
[data-theme="dark"] .home-footer .m3-btn-outlined:hover{{background:#2C2C2E;}}
