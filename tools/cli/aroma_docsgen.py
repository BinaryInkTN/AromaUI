...
.home-live{{display:flex;gap:16px;align-items:center;margin-bottom:64px}}
.home-live-copy{{flex:1 1 0;min-width:0}}
.home-live-copy .section-heading{{margin-bottom:12px}}
.home-live-text{{color:var(--md-on-surface-var);margin:0 0 14px;font-size:14px;line-height:1.65;max-width:68ch}}
