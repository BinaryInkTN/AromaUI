...
// include: /tmp/tmpokxhlt6d.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'infotainment.data';
      var REMOTE_PACKAGE_BASE = 'infotainment.data';
...
Module['FS_createPath']("/", "assets", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_infotainment.data');
      }
      Module['addRunDependency']('datafile_infotainment.data');
    ...
    loadPackage({"files": [{"filename": "/assets/Ubuntu-Bold.ttf", "start": 0, "end": 339320}, {"filename": "/assets/Ubuntu-Light.ttf", "start": 339320, "end": 701872}, {"filename": "/assets/abs_indicator.png", "start": 701872, "end": 705808}, {"filename": "/assets/air-conditioner.png", "start": 705808, "end": 708057}, {"filename": "/assets/album_cover.jpg", "start": 708057, "end": 1224901}, {"filename": "/assets/aromaos_logo.png", "start": 1224901, "end": 1264823}, {"filename": "/assets/backroad_blur.png", "start": 1264823, "end": 1281430}, {"filename": "/assets/backroad_dark.png", "start": 1281430, "end": 1317850}, {"filename": "/assets/battery.png", "start": 1317850, "end": 1325954}, {"filename": "/assets/battery_indicator.png", "start": 1325954, "end": 1326871}, {"filename": "/assets/both.png", "start": 1326871, "end": 1329568}, {"filename": "/assets/brake_indicator.png", "start": 1329568, "end": 1332875}, {"filename": "/assets/car.png", "start": 1332875, "end": 1496441}, {"filename": "/assets/car_battery.png", "start": 1496441, "end": 3388036}, {"filename": "/assets/charging.png", "start": 3388036, "end": 3397716}, {"filename": "/assets/high_beams.png", "start": 3397716, "end": 3400293}, {"filename": "/assets/low_beams.png", "start": 3400293, "end": 3402449}, {"filename": "/assets/maps_example.jpg", "start": 3402449, "end": 3518101}, {"filename": "/assets/sample.wav", "start": 3518101, "end": 3870945}, {"filename": "/assets/seatbelt.png", "start": 3870945, "end": 3872685}, {"filename": "/assets/splash.gif", "start": 3872685, "end": 5912854}, {"filename": "/assets/temperature.png", "start": 5912854, "end": 5914600}, {"filename": "/assets/test.png", "start": 5914600, "end": 6569074}, {"filename": "/assets/under.png", "start": 6569074, "end": 6571333}], "remote_package_size": 6571333});

  })();

// end include: /tmp/tmpokxhlt6d.js
// include: /tmp/tmpy0s4iv1y.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpy0s4iv1y.js
// include: /tmp/tmp57dti_t7.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp57dti_t7.js
...
function findWasmBinary() {
  return locateFile('infotainment.wasm');
}
...
var ASM_CONSTS = {
  1653231: ($0, $1, $2, $3) => { if (typeof window !== 'undefined') { window.aromaLastMouseDispatchAction = $0; window.aromaLastMouseDispatchX = $1; window.aromaLastMouseDispatchY = $2; window.aromaLastMouseDispatchButton = $3; } console.log('dispatch_mouse', $0, $1, $2, $3); },  
 1653479: ($0, $1, $2, $3, $4) => { if (typeof window !== 'undefined') { window.aromaLastMouseType = $0; window.aromaLastMouseTarget = $1; window.aromaLastMouseX = $2; window.aromaLastMouseY = $3; window.aromaLastMouseButton = $4; } }
};
...
function _aroma_resize_canvas_for_dpr(selector,css_w,css_h,dpr) { var sel = UTF8ToString(selector); var el = document.querySelector(sel); if (!el) return; el.width = Math.round(css_w * dpr); el.height = Math.round(css_h * dpr); el.style.width = css_w + 'px'; el.style.height = css_h + 'px'; }
...
var _aroma_event_handle_touch = Module['_aroma_event_handle_touch'] = makeInvalidEarlyAccess('_aroma_event_handle_touch');
var _aroma_event_handle_pointer_move = Module['_aroma_event_handle_pointer_move'] = makeInvalidEarlyAccess('_aroma_event_handle_pointer_move');
var _aroma_test_get_last_mouse_event_type = Module['_aroma_test_get_last_mouse_event_type'] = makeInvalidEarlyAccess('_aroma_test_get_last_mouse_event_type');
var _aroma_test_get_last_mouse_event_x = Module['_aroma_test_get_last_mouse_event_x'] = makeInvalidEarlyAccess('_aroma_test_get_last_mouse_event_x');
var _aroma_test_get_last_mouse_event_y = Module['_aroma_test_get_last_mouse_event_y'] = makeInvalidEarlyAccess('_aroma_test_get_last_mouse_event_y');
var _aroma_test_get_last_mouse_event_target = Module['_aroma_test_get_last_mouse_event_target'] = makeInvalidEarlyAccess('_aroma_test_get_last_mouse_event_target');
var _aroma_emscripten_dispatch_mouse = Module['_aroma_emscripten_dispatch_mouse'] = makeInvalidEarlyAccess('_aroma_emscripten_dispatch_mouse');
...
var dynCall_viiiiiiif = makeInvalidEarlyAccess('dynCall_viiiiiiif');
var dynCall_viiiiiiiif = makeInvalidEarlyAccess('dynCall_viiiiiiiif');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['aroma_event_handle_touch'] != 'undefined', 'missing Wasm export: aroma_event_handle_touch');
  assert(typeof wasmExports['aroma_event_handle_pointer_move'] != 'undefined', 'missing Wasm export: aroma_event_handle_pointer_move');
  assert(typeof wasmExports['aroma_test_get_last_mouse_event_type'] != 'undefined', 'missing Wasm export: aroma_test_get_last_mouse_event_type');
  assert(typeof wasmExports['aroma_test_get_last_mouse_event_x'] != 'undefined', 'missing Wasm export: aroma_test_get_last_mouse_event_x');
  assert(typeof wasmExports['aroma_test_get_last_mouse_event_y'] != 'undefined', 'missing Wasm export: aroma_test_get_last_mouse_event_y');
  assert(typeof wasmExports['aroma_test_get_last_mouse_event_target'] != 'undefined', 'missing Wasm export: aroma_test_get_last_mouse_event_target');
  assert(typeof wasmExports['aroma_emscripten_dispatch_mouse'] != 'undefined', 'missing Wasm export: aroma_emscripten_dispatch_mouse');
  ...
  assert(typeof wasmExports['dynCall_viiiiiiif'] != 'undefined', 'missing Wasm export: dynCall_viiiiiiif');
  assert(typeof wasmExports['dynCall_viiiiiiiif'] != 'undefined', 'missing Wasm export: dynCall_viiiiiiiif');
  assert(typeof wasmExports['dynCall_viiiiffii'] != 'undefined', 'missing Wasm export: dynCall_viiiiffii');
  assert(typeof wasmExports['dynCall_viiiiiif'] != 'undefined', 'missing Wasm export: dynCall_viiiiiif');
  assert(typeof wasmExports['dynCall_fiiif'] != 'undefined', 'missing Wasm export: dynCall_fiiif');
  ...
  _aroma_event_handle_touch = Module['_aroma_event_handle_touch'] = createExportWrapper('aroma_event_handle_touch', 4);
  _aroma_event_handle_pointer_move = Module['_aroma_event_handle_pointer_move'] = createExportWrapper('aroma_event_handle_pointer_move', 3);
  _aroma_test_get_last_mouse_event_type = Module['_aroma_test_get_last_mouse_event_type'] = createExportWrapper('aroma_test_get_last_mouse_event_type', 0);
  _aroma_test_get_last_mouse_event_x = Module['_aroma_test_get_last_mouse_event_x'] = createExportWrapper('aroma_test_get_last_mouse_event_x', 0);
  _aroma_test_get_last_mouse_event_y = Module['_aroma_test_get_last_mouse_event_y'] = createExportWrapper('aroma_test_get_last_mouse_event_y', 0);
  _aroma_test_get_last_mouse_event_target = Module['_aroma_test_get_last_mouse_event_target'] = createExportWrapper('aroma_test_get_last_mouse_event_target', 0);
  _aroma_emscripten_dispatch_mouse = Module['_aroma_emscripten_dispatch_mouse'] = createExportWrapper('aroma_emscripten_dispatch_mouse', 4);
  ...
  dynCall_viiiiiiif = dynCalls['viiiiiiif'] = createExportWrapper('dynCall_viiiiiiif', 9);
  dynCall_viiiiiiiif = dynCalls['viiiiiiiif'] = createExportWrapper('dynCall_viiiiiiiif', 10);
  dynCall_viiiiffii = dynCalls['viiiiffii'] = createExportWrapper('dynCall_viiiiffii', 9);
  dynCall_viiiiiif = dynCalls['viiiiiif'] = createExportWrapper('dynCall_viiiiiif', 8);
  dynCall_fiiif = dynCalls['fiiif'] = createExportWrapper('dynCall_fiiif', 5);
...
var wasmImports = {
  ...
  /** @export */
  _aroma_get_device_pixel_ratio,
  /** @export */
  _aroma_resize_canvas_for_dpr,
  /** @export */
